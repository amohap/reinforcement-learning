...
save_path_dataframe_nmoves="experiments/{}/ep{}_be{}_ga{}_et{}/N_moves_ER.csv".format(filename, args.epsilon, args.gamma, args.eta)
save_path_plots_nmoves="experiments/{}/ep{}_be{}_ga{}_et{}/nmoves.png".format(filename, args.epsilon, args.gamma, args.eta)

save_path_dataframe_reward="experiments/{}/ep{}_be{}_ga{}_et{}/R_save_ER.csv".format(filename, args.epsilon, args.gamma, args.eta)
save_path_plots_rsave="experiments/{}/ep{}_be{}_ga{}_et{}/rsave.png".format(filename, args.epsilon, args.gamma, args.eta)

save_path_dataframe_delta="experiments/{}/ep{}_be{}_ga{}_et{}/Delta_save_ER.csv".format(filename, args.epsilon, args.gamma, args.eta)
